...
# 3. Класс MysticBall с методом __call__
class MysticBall:
...
print(first_ball())
"""
Этот код включает в себя все три задачи: он сравнивает буквы в двух строках, создает функцию для записи данных в файл и
 реализует класс с методом `__call__`, который возвращает случайное слово из заданного списка."""